...
export default function SearchBar({ brands }: Props) {
  ...
  return (
    <div className="flex w-full items-center gap-4 rounded-xl bg-white-background p-2 px-6 font-manrope font-medium shadow-xl">
      {/* LOCATION */}
